...
int main()
{
    ...
    for (int movement = 1; movement <= path_length; ++movement)
    {
        ...
        {
            // Update the matrix at the previous source position to '0'
            matrix[srcX][srcY] = 0;
            ...
            // Update the matrix at the new source position to '#'
            matrix[srcX][srcY] = sourceChar;
        }
    }
